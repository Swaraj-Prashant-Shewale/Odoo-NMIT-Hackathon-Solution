...
final class Reviews extends Repository
{
    ...
    public function visibleTo(string $employeeId, array $filters, int $page, int $perPage): array
    {
        ...
        if ($scope === 'organisation') {
            // Everything, for a caller the controller has already checked holds
            // talent.view.all. Without this the company-wide rating report was
            // built from whatever reviews the person running it happened to be
            // a party to, which for most people is none.
            $conditions[] = '1 = 1';
        } elseif ($scope === 'to_complete') {
