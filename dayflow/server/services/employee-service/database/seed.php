...
foreach ($people as $person) {
    ...
    $employees->create([
        ...
        'manager_id' => $person['manager'] === null ? null : $PERSON[$person['manager']],
        'employment_type' => 'full_time',
        // Everyone in the sample joined years ago, so probation is long past.
        'employment_status' => 'confirmed',
        'joined_on' => $person['joined_on'],
        'probation_end_on' => $probationEnd->format('Y-m-d'),
        'confirmed_on' => $probationEnd->format('Y-m-d'),
        'is_active' => true,
    ]);
}
