...
final class Router
{
    /** @var list<array{method: string, regex: string, parameters: list<string>, handler: array, guest: bool, permission: ?string}> */
    ...
    /**
     * @param array{method: string, handler: array, guest: bool, permission: ?string} $route
    ...
    private function add(string $method, string $pattern, array $handler): RouteOptions
    {
        ...
        return new RouteOptions(function (bool $guest, ?string $permission) use ($index): void {
