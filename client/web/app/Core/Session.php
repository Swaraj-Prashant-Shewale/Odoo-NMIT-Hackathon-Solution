...
final class Session
{
    ...
    {
        // The identity service calls it "id"; "user_id" was never in the
        // payload, so this returned null and every audit line the client wrote
        // was anonymous.
        $value = self::user()['id'] ?? self::user()['user_id'] ?? null;
    ...
    public static function displayName(): string
    {
        ...
        // Sign-in returns first_name, last_name and full_name - never "name" -
        // so this fell through to the placeholder and greeted the entire
        // company as "there", including in the nav bar avatar.
